...
"Reviewer PASS"      → Remind me to do MY REVIEW (Step D), then give STEP E (merge) instructions. Before opening next Architect planning: verify workspace/iterations/I[N]/brief.md exists on disk.
